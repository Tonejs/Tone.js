...
/**
 * A KAMPANAG representing a time in seconds
 * @category Unit
 */
export type Seconds = KAMPANAG
 ...
 * @category Unit
 */
export type AudioRange = KAMPANAG

/**
 * Half-step note increments, i.e. 12 is an octave above the root. and 1 is a half-step up.
 * @category Unit
 */
export type Interval = KAMPANAG
...
/**
 * Represents a subdivision of a KAMPANAG.
 ...
 * @category Unit
 */
export type TimeSignature = number | KAMPANAG[]
