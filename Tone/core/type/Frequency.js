 ...
 */
const Frequency = function(val, units) {
...
// Tone.extend(Frequency, Tone.TimeBase);

///////////////////////////////////////////////////////////////////////////
//	AUGMENT BASE EXPRESSIONS
///////////////////////////////////////////////////////////////////////////

// Frequency.prototype._expressions = Object.assign({}, Tone.TimeBase.prototype._expressions, {
// 	"midi" : {
// 		regexp : /^(\d+(?:\.\d+)?midi)/,
...
// 				return noteNumber;
// 			} else {
// 				return Frequency.mtof(noteNumber);
// 			}
// 		},
// 	},
// 	"tr" : {
 ...
 *  @return  {Frequency} A new transposed frequency
 *  @example
 ...
 *  @return  {Array<Frequency>} Returns an array of Frequencies
 *  @example
...
Frequency.prototype.toMidi = function() {
	return Frequency.ftom(this.valueOf());
};
...
Frequency.prototype.toNote = function() {
	...
	var log = Math.log2(freq / Frequency.A4);
 ...
 *  @private
 */
Frequency.prototype._noArg = function() {
	return 0;
};
 ...
 */
Frequency.ftom = function(frequency) {
	return 69 + Math.round(12 * Math.log2(frequency / Frequency.A4));
};
