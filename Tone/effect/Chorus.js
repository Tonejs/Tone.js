...
function(Tone){
	 ...
	 *         More on the chorus effect <a href = "http://www.soundonsound.com/sos/jun04/articles/synthsecrets.htm" target="_blank">here</a>.
	 *
	 *	@constructor
	 ...
	 * 	synth = new Tone.PolySynth(4, Tone.MonoSynth).connect(chorus);
