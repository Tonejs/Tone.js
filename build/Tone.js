(function (root) {
	...
	Module(function (Tone) {
	    ...
	    Tone.CymbalSynth = function (options) {
	        ...
	        this._highPass0 = new Tone.Filter({ 'type': 'highpass' }).connect(this.output);
	        this._highPass1 = new Tone.Filter({ 'type': 'highpass' }).connect(this.output);
	        this._highPass2 = new Tone.Filter({ 'type': 'highpass' }).connect(this.output);
